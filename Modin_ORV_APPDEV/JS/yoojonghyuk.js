        ...
        if (event.target.tagName === "IMG") {
            ...
            switch (imageIndex) {
                case "1":
                    ...
                    console.log("Clicked on Yoo Jonghyuk 1");
                    break;
                case "2":
                    // Action for the second image
                    console.log("Clicked on Yoo Jonghyuk 2");
                    break;
                case "3":
                    // Action for the third image
                    console.log("Clicked on Yoo Jonghyuk 3");
                    break;
                case "4":
                    console.log("Clicked on Yoo Jonghyuk 4");
                    break;
                case "5":
                    console.log("Clicked on Yoo Jonghyuk 5");
                    break;    
